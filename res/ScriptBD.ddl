DROP DATABASE streamingMusic IF EXISTS;
CREATE DATABASE streamingMusic;
USE streamingMusic;
CREATE TABLE Artiste (id int(10) NOT NULL AUTO_INCREMENT, nom int(10) NOT NULL, prenom int(10), biographie int(10), pays int(10), PRIMARY KEY (id));
