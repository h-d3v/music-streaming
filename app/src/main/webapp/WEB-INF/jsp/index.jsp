...
<header class="masthead text-center text-white">
    <div class="masthead-content">
        <a class="container">
            ...
            <h2 class="masthead-subheading mb-0">Enfin presque, on n'a pas les droits</h2><a href="/titreSearch"><button class="btn btn-primary btn-xl rounded-pill mt-5"  type="button">Explorer les titres</button></a></div>
    </div>
