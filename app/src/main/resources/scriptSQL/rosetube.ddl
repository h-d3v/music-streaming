...
CREATE TABLE Utilisateur (pseudo varchar(255) NOT NULL, courriel varchar(50) NOT NULL, motPasse varchar(255) NOT NULL, estAdmin BOOLEAN DEFAULT FALSE,PRIMARY KEY (pseudo));
